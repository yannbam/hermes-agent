...
Prefer read_file tool for trivial file reads.
Prefer patch tool for manually editing files.
Prefer write tool for manually creating files.

*Opens the gate to the TERMINAL*
