...
TIPS = [
    ...
    "/verbose cycles tool progress display: off → new → all → detailed → verbose.",
    ...
    "Set display.busy_input_mode: queue to queue messages, steer to inject them mid-run, or pause to make Enter request a soft pause while Hermes is busy.",
